 ...
 *
 * 2019 Frank Wang 版权所有
 */

public class IconView extends LinearLayout implements GestureDetector.OnGestureListener {
    ...
    public IconView(Context context, AttributeSet attrs) {
        ...
        //从布局文件中读取布局并查找控件
        LayoutInflater.from(context).inflate(R.layout.icon_view_layout, this, true);
